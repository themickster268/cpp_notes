...
int main(){
    ...
    // unsigned int value4 {-5}; // Results in Compiler error

    // short and long
    short short_var{-32768};                 //  short - 2 Bytes
    ...
    long long_var{88}; // long - 4 OR 8 Bytes
    long int long_int{33};
    signed long signed_long{44};
    signed long int signed_long_int{44};
    unsigned long int unsigned_long_int{44};

    long long long_long{888}; // long long - 8 Bytes
