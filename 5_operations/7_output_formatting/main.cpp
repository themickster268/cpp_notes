...
int main(){
    ...
    // std::endl - adds newline character '\n' to output stream
    std::cout << "Hello";
    std::cout << "World";
    ...
    // After this std::flush, we're sure that at this line, the message has
    // been sent to the stream. This may be important in some applications.
    ...
    std::cout << std::setw(col_width) << "Firstname" << std::setw(col_width) << "Lastname" << std::setw(5) << "Age" << std::endl;
    ...
    // std::boolalpha and noboolalpha - controls boolean output
    ...
    // std::showpos and noshowpos - shows/hides the + sign for positive numbers
    ...
    std::cout << "post_int (oct): " << std::oct << pos_int << std::endl;
    ...
    double a {3.141592563589793238463643383295};
    double b {2006.0};
    double c {1.34e-10};

    std::cout << std::endl;
    std::cout << "double values (default : use scientific notation where necessary):" << std::endl;
    ...
    // setprecision() - the number of digits printed out for a floating point number

    a = 3.141592563589793238463643383295;
    std::cout << std::endl;
    ...
    // showpoint and noshowpoint - shows trailing zeros if necessary
